...
class _IngredientDraft {
  _IngredientDraft({required this.qty, required this.unit, required this.name});
...
class _RecipeEditorScreenState extends State<RecipeEditorScreen> {
  ...
  void initState() {
    super.initState();
    _titleController = TextEditingController(text: 'Roasted Heirloom Carrots');
  }
          ...
          Expanded(
            child: ListView(
              ...
              children: [
                ...
                _SectionHeader(icon: Icons.restaurant, label: 'Ingredients'),
