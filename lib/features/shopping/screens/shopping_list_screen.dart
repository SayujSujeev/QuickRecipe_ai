...
import '../../recipes/screens/add_recipes_screen.dart';
...
class _ShoppingListScreenState extends State<ShoppingListScreen> {
  ...
  List<_ShopItem> get _checkedItems =>
      [..._produce, ..._dairy, ..._pantry].where((i) => i.checked).toList();
                ...
                IconButton(
                  onPressed: () {
                    Navigator.of(context).push(
                      MaterialPageRoute(builder: (_) => const MyPantryScreen()),
                    );
                  },
                  icon: const Icon(
                    Icons.menu_rounded,
                ...
                GestureDetector(
                  ...
                  child: Row(
                    children: [
                      ...
                      const Spacer(),
                      Icon(
                        _showChecked ? Icons.expand_less : Icons.expand_more,
                        color: AppColors.olive,
                      ),
                    ],
                  ),
                ...
                if (_showChecked) ...[
                  ...
                  ..._checkedItems.map(
                    (item) => Opacity(
                      ...
                      child: _ItemRow(
                        item: item,
                        onToggle: () => setState(() => item.checked = false),
                      ),
                    ),
                  ),
                ],
        ...
        child: Row(
          children: [
            Icon(
              ...
              color: item.checked ? AppColors.olive : AppColors.textMuted,
              size: 26,
            ),
