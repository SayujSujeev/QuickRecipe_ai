      ...
      body: SafeArea(
        child: ListView(
          ...
          children: [
            ...
            const SizedBox(height: 20),
            const _Feature(icon: Icons.auto_awesome, label: 'Unlimited AI Imports'),
            const _Feature(
            ...
            Row(
              ...
              children: [
                _Trust(icon: Icons.verified_user_outlined, label: 'Secure Payments'),
                _Trust(icon: Icons.star_outline, label: '4.9/5 Kitchen Rating'),
                _Trust(icon: Icons.shield_outlined, label: 'Privacy Guaranteed'),
              ],
            ),
          ],
        ),
          ...
          Container(
            ...
            child: Column(
              children: [
                ...
                Row(
                  children: [
                    const Icon(Icons.check, size: 16, color: AppColors.terracotta),
