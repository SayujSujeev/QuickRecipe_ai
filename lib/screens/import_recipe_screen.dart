...
class _ImportRecipeScreenState extends State<ImportRecipeScreen> {
  ...
  Future<void> _pasteAndImport() async {
    ...
    if (text != null && text.isNotEmpty) {
      ...
      _controller.text = 'https://www.tiktok.com/@chef/video/123';
    }
    ...
    await Navigator.of(context).push(
      MaterialPageRoute(builder: (_) => const ImportErrorScreen()),
    );
  }
                          ...
                          Text.rich(
                            TextSpan(
                              ...
                              children: const [
                                ...
                                TextSpan(
                                  text: ' on your favorite video app.',
                                ),
                              ],
                            ),
                          ),
